    ...
    <section className="w-full bg-secondary px-4 md:px-8 py-28 flex flex-col items-center justify-center gap-8">
      ...
      >
        <h2 className="text-3xl md:text-5xl font-poppins text-tertiary-light font-semibold">
          What Our <span className=" font-semibold">Clients</span> Say
        </h2>
      </motion.div>
          ...
          >
            <div className="flex flex-col gap-3">
              ...
              <div className="flex flex-row items-center gap-2 pt-2 border-t border-slate-50">
                <p className="font-semibold text-slate-900 text-xs font-poppins truncate">{r.tenant_name || 'Verified Client'}</p>
              </div>
            </div>
          </motion.div>
        ))}
